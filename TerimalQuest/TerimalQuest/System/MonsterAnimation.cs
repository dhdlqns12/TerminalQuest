...
"
        ...
        private static void InitKefgaAnimation()
        {
            animations["케프가"] = new Dictionary<AnimationType, string[]>
            {
                [AnimationType.Idle] = new string[]
                {
            @"
...
"
        ...
        private static void InitLabosAnimation()
        {
            animations["라보스"] = new Dictionary<AnimationType, string[]>
            {
                [AnimationType.Idle] = new string[]
                {
            @"
