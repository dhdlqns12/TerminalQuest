...
namespace TerimalQuest.Core
{
    ...
    public class Job
    {
        ...
        private void InitWarrior()
        {
            ...
            Skill bash = new Skill("배쉬", "힘을 세게주어 2배의 데미지",  2f, SkillType.Attack, SkillDamageType.BaseAttack, SkillRangeType.One, 10);
            Skill powerBash = new Skill("파워배쉬", "온 힘을 다해 공격하여 모든 적에게 공격력 2.5배의 데미지",  2.5f, SkillType.Attack, SkillDamageType.BaseAttack, SkillRangeType.All,  30);
        ...
        private void InitArcher()
        {
            ...
            Skill arrowRain = new Skill("화살비", "모든 적에게 공격력 *0.9의 데미지",  0.9f, SkillType.Attack,  SkillDamageType.BaseAttack, SkillRangeType.All, 20);
            Skill arrowBomb = new Skill("폭발화살", "화살에 폭탄을 장착하고 발사해 모든 적에게 공격력 * 2의 데미지",  2f, SkillType.Attack,  SkillDamageType.BaseAttack, SkillRangeType.All, 100);
        ...
        private void InitMage()
        {
            ...
            Skill meteor = new Skill("메테오", "모든 적에게 운석을 떨어뜨려 180의 고정데미지",  180, SkillType.Attack, SkillDamageType.FixedDamage, SkillRangeType.All, 70);
            Skill ragnarok = new Skill("라그나로크", "암흑 에너지를 발산시켜 모든 적에게 300의 고정데미지",  300, SkillType.Attack, SkillDamageType.FixedDamage, SkillRangeType.All, 200);
