...
namespace TerimalQuest.Core
{
    ...
    public class Job
    {
        ...
        private void InitArcher()
        {
            ...
            Skill arrowBomb = new Skill("폭발화살", "화살에 폭탄을 장착하고 발사해 모든 적에게 공격력 * 1.5의 데미지",  1.5f, SkillType.Attack,  SkillDamageType.BaseAttack, SkillRangeType.One, 20);
        ...
        private void InitMage()
        {
            ...
            evadeRate = 0f;
            //기본 스킬 추가
            Skill blizzard = new Skill("블리자드", "모든 적에게 냉기를 발산해 200의 고정데미지",  200, SkillType.Attack, SkillDamageType.FixedDamage, SkillRangeType.All, 30);
            Skill meteor = new Skill("메테오", "모든 적에게 운석을 떨어뜨려 300의 고정데미지",  300, SkillType.Attack, SkillDamageType.FixedDamage, SkillRangeType.All, 55);
            Skill ragnarok = new Skill("라그나로크", "암흑 에너지를 발산시켜 모든 적에게 1000의 고정데미지",  1000, SkillType.Attack, SkillDamageType.FixedDamage, SkillRangeType.All, 150);
