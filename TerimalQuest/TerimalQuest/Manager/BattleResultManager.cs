    ...
    public class BattleResultManager
    {
        ...
        private void InitializeDropTable()
        {
            ...
            dropTable.Add("슬라임", new List<DropItem>
            {
                ...
                new DropItem { itemName = "강화석", minDropCount = 3, maxDropCount = 10, dropRate = 0.5f},
            ...
            dropTable.Add("오크", new List<DropItem>
            {
                ...
                new DropItem { itemName = "강화석", minDropCount = 4, maxDropCount = 10, dropRate = 0.5f}
            });
            ...
            dropTable.Add("트롤", new List<DropItem>
            {
                ...
                new DropItem { itemName = "강화석", minDropCount = 5, maxDropCount = 10, dropRate = 0.5f}
            });
        }
    }
}